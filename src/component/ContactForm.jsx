    ...
    <div className="container mx-auto px-4 mt-8">
      <form className="max-w-md mx-auto p-4 bg-white shadow-md rounded-md" onSubmit={handleSubmit}>
        ...
        <div className="mb-6">
          ...
          <textarea
            className={`appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline ${errors.message && 'border-red-500'}`}
            id="message"
            rows="4"
            name="message"
